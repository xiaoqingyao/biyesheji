<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCMoneyManger.aspx.cs" Inherits="UserManger_LCMoneyManger" %>
...
<table width="100%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#20b1f3" style="margin-bottom:8px;margin-top:8px;">
  <tr>
    <td   class='title'><span>家庭理财信息管理</span></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td>
        存款时间从：<asp:TextBox ID="txtf" runat="server"></asp:TextBox>
        到：<asp:TextBox ID="txtt" runat="server"></asp:TextBox>
            ...
            <Columns>
             <asp:TemplateField HeaderText="存款银行">
                ...
                <asp:TemplateField HeaderText="查看修改">
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyLCMoney.aspx?id="+Eval("id") %>'
