<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyMoney.aspx.cs" Inherits="Admin_ModifyMoney" %>
...
<table width="100%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#20b1f3" style="margin-bottom:8px;margin-top:8px;">
  <tr>
    <td   class='title'><span>修改家庭收支信息</span></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="left">
        <table border="0" cellpadding="0" cellspacing="0" class="text008" width="100%">
            <tr align="center">
                <td align="right" height="35" width="12%">
                    收支项目</td>
                <td align="left" width="88%">
                    <asp:DropDownList ID="drpParentItem" runat="server" 
                        Width="150px">
                    </asp:DropDownList>
                </td>
            </tr>
