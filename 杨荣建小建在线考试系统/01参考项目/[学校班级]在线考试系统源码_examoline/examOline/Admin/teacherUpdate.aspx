<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teacherUpdate.aspx.cs" Inherits="Admin_teacherUpdate" %>
        ...
        <table style="width: 531px; height: 343px"　border="1" >
            ...
            <tr>
                <td colspan="3" style="text-align: center">
                    ...
                    &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<asp:Button ID="btncen" runat="server" OnClick="btncen_Click"
                        Text="取消" /></td>
            </tr>
        </table>
