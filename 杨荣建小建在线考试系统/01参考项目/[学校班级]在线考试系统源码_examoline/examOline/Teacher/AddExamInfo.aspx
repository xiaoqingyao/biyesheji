<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddExamInfo.aspx.cs" Inherits="Teacher_AssembledExam" %>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" style="width: 568px;
                ...
                <tr>
                    ...
                    <td style="width: 72px; height: 29px; text-align: left;">
                        <asp:TextBox ID="txtPropositionPeopleID" runat="server"></asp:TextBox></td>
...
controlToValidate="txtLimitedTime" 
type="Integer" 
MinimumValue="0" 
MaximumValue="1000" 
errorMessage="请输入正确的数值" ID="RangeValidator11"  
                ...
                <tr>
                    ...
                    <td colspan="1" style="width: 68px; height: 43px; text-align: left">
                        &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtSchooseNum"
                            ErrorMessage="输入不能为空">*</asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtSchooseNum"
                            ErrorMessage="请输入正确的数值" MaximumValue="100" MinimumValue="0" Type="Integer">*</asp:RangeValidator></td>
                    ...
                    <td style="width: 75px; height: 43px">
                        &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtSchoosePoint"
                            ErrorMessage="输入不能为空">*</asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator6" runat="server" ControlToValidate="txtSchoosePoint"
                            ErrorMessage="请输入正确的数值" MaximumValue="100" MinimumValue="0" Type="Integer">*</asp:RangeValidator></td>
                </tr>
                <tr>
...
--%>
                    ...
                    <td colspan="1" style="width: 68px; height: 42px; text-align: left">
                        &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtMchooseNum"
                            ErrorMessage="输入不能为空">*</asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="txtMchooseNum"
                            ErrorMessage="请输入正确的数值" MaximumValue="100" MinimumValue="0" Type="Integer">*</asp:RangeValidator></td>
                    ...
                    <td style="width: 75px; height: 42px">
                        &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtMchoosePoint"
                            ErrorMessage="输入不能为空">*</asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator7" runat="server" ControlToValidate="txtMchoosePoint"
                            ErrorMessage="请输入正确的数值" MaximumValue="100" MinimumValue="0" Type="Integer">*</asp:RangeValidator></td>
                </tr>
                <tr>
                    <td style="width: 148px; height: 42px; text-align: center">
                    ...
                    <td colspan="1" style="width: 68px; height: 42px; text-align: left">
                        &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtInputNum"
                            ErrorMessage="输入不能为空">*</asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator3" runat="server" ControlToValidate="txtInputNum"
                            ErrorMessage="请输入正确的数值" MaximumValue="100" MinimumValue="0" Type="Integer">*</asp:RangeValidator></td>
                    <td style="width: 175px; height: 42px">
                        填空题单题分值:</td>
                    <td style="width: 72px; height: 42px">
                    ...
                    <td style="width: 75px; height: 42px">
                        &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtInputPoint"
                            ErrorMessage="输入不能为空">*</asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator8" runat="server" ControlToValidate="txtInputPoint"
                            ErrorMessage="请输入正确的数值" MaximumValue="100" MinimumValue="0" Type="Integer">*</asp:RangeValidator></td>
                </tr>
                <tr>
                    <td style="width: 148px; height: 42px; text-align: center">
                    ...
                    <td colspan="1" style="width: 68px; height: 42px; text-align: left">
                        &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtJudgeNum"
                            ErrorMessage="输入不能为空">*</asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator4" runat="server" ControlToValidate="txtJudgeNum"
                            ErrorMessage="请输入正确的数值" MaximumValue="100" MinimumValue="0" Type="Integer">*</asp:RangeValidator></td>
                    <td style="width: 175px; height: 42px">
                        判断题单题分值:</td>
                    <td style="width: 72px; height: 42px">
                    ...
                    <td style="width: 75px; height: 42px">
                        &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtJudgePoint"
                            ErrorMessage="输入不能为空">*</asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator9" runat="server" ControlToValidate="txtJudgePoint"
                            ErrorMessage="请输入正确的数值" MaximumValue="100" MinimumValue="0" Type="Integer">*</asp:RangeValidator></td>
                </tr>
                <tr>
                    <td style="width: 148px; height: 42px; text-align: center">
                    ...
                    <td colspan="1" style="width: 68px; height: 42px; text-align: left">
                        &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtApplicationNum"
                            ErrorMessage="输入不能为空">*</asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator5" runat="server" ControlToValidate="txtApplicationNum"
                            ErrorMessage="请输入正确的数值" MaximumValue="100" MinimumValue="0" Type="Integer">*</asp:RangeValidator></td>
                    <td style="width: 175px; height: 42px">
                        应用题单题分值:</td>
                    <td style="width: 72px; height: 42px">
                    ...
                    <td style="width: 75px; height: 42px">
                        &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtApplicationPoint"
                            ErrorMessage="输入不能为空">*</asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator10" runat="server" ControlToValidate="txtApplicationPoint"
                            ErrorMessage="请输入正确的数值" MaximumValue="100" MinimumValue="0" Type="Integer">*</asp:RangeValidator></td>
                </tr>
                <tr>
                    <td style="width: 148px; height: 42px; text-align: center">
                    ...
                    <td colspan="1" style="width: 68px; height: 42px; text-align: left">
                        <asp:RequiredFieldValidator
                                ID="RequiredFieldValidator13" runat="server" ControlToValidate="txtPass" ErrorMessage="输入不能为空">*</asp:RequiredFieldValidator><asp:RangeValidator ID="RangeValidator12" runat="server" ControlToValidate="txtPass"
                            ErrorMessage="请输入正确的数值" MaximumValue="100" MinimumValue="0" Type="Integer">*</asp:RangeValidator></td>
                    <td style="width: 175px; height: 42px">
                        <asp:Button ID="btnStat" runat="server" Text="统计总分" OnClick="btnStat_Click" /></td>
                    <td style="width: 72px; height: 42px">
                ...
                <tr>
                    <td colspan="6" style="height: 43px; text-align: center">
                        ...
                        &nbsp; &nbsp;&nbsp;<asp:Button ID="btnCancel" runat="server" Text="重置" CausesValidation="False" /></td>
