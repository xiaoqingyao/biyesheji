<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangeQuestionApplicationInfo.aspx.cs" Inherits="Teacher_ChangeQuestionApplicationInfo" %>
...
<body>
    ...
    <fieldset style="WIDTH: 483px; HEIGHT: 343px">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style=" text-align:center; width: 441px; height: 357px;">
            ...
            <tr>
                ...
                <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="保存" Font-Size="14pt" Height="29px" Width="75px" />
                    &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<asp:Button ID="btnCancel" OnClick="btnCancel_Click" runat="server" Text="取消" Font-Size="14pt" Height="28px" Width="75px" />
                    &nbsp; &nbsp; &nbsp;
                    </td>
            </tr>
            <tr>
