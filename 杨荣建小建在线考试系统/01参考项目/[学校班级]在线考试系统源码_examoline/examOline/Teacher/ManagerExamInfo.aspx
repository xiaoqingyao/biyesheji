<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManagerExamInfo.aspx.cs" Inherits="Teacher_ManagerQuestionSC" %>
...
<body>
    ...
    <div style="text-align: center">
        ...
        <fieldset style="width: 542px; height: 650px">
            <legend class="mailTitle" style="width: 193px; text-align: center;">试卷管理</legend>&nbsp; &nbsp; &nbsp;&nbsp;<br />
        ...
        <asp:GridView ID="gvExaminationInfo" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            <Columns>
                <asp:BoundField DataField="ExamTitle" HeaderText="试卷标题" />
                <asp:BoundField DataField="ExamName" HeaderText="试卷名" />
                <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="ChangeExamInfo.aspx?EIid={0}"
