<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManagerQuestionJudge.aspx.cs" Inherits="Teacher_ManagerQuestionJudge" %>
...
<body>
    ...
    <div style="text-align: center">
        ...
        <br />
        <br />
        <fieldset style="width: 542px; height: 475px">
            <legend class="mailTitle" style="width: 193px">试题管理－－－判断题</legend>&nbsp; &nbsp; &nbsp;&nbsp;<br />
        ...
        <asp:GridView ID="gvExaminationInfo" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="ChangeQuestionJudgeInfo.aspx?Jid={0}"
