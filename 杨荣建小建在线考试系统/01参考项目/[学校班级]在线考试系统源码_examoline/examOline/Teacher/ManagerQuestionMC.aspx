<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManagerQuestionMC.aspx.cs" Inherits="Teacher_ManagerQuestionMC" %>
...
<body>
    ...
    <div style="text-align: center">
        ...
        <br />
        <br />
        <fieldset style="width: 542px; height: 456px">
            <legend class="mailTitle" style="width: 193px">试题管理－－－多选题</legend>&nbsp; &nbsp; &nbsp;&nbsp;<br />
        ...
        <asp:GridView ID="gvExaminationInfo" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="ChangeQuestionMCInfo.aspx?MCid={0}"
