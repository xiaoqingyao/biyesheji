<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManagerQuestionSC.aspx.cs" Inherits="Teacher_ManagerQuestionSC" %>
...
<body>
    ...
    <div style="text-align: center">
        ...
        <br />
        <br />
        <fieldset style="width: 542px; height: 476px">
            <legend class="mailTitle" style="width: 193px">试题管理－－－单项选择</legend>&nbsp; &nbsp; &nbsp;&nbsp;<br />
        ...
        <asp:GridView ID="gvExaminationInfo" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="ChangeQuestionSCInfo.aspx?SCid={0}"
