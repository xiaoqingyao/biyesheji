...
if ($addnew=="1" )
{
	...
	$sql="update meishidaren set yonghuming='$yonghuming',mima='$mima',xingming='$xingming',xingbie='$xingbie',touxiang='$touxiang',xihao='$xihao',dianhua='$dianhua',dizhi='$dizhi',beizhu='$beizhu' where yonghuming= '".$_SESSION["username"]."'";
	mysql_query($sql);
...
<?php
$sql="select * from meishidaren where yonghuming='".$_SESSION["username"]."'";
