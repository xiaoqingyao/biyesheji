...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  ...
  <?php 
    $sql="select * from meishixinxi where faburen='".$_SESSION['username']."'";
...
//youzuiping2
  ...
  <tr>
	...
	<?php if(mysql_result($query,$i,issh)=="否"){?><a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=meishixinxi" onclick="return confirm('真的要删除？')">删除</a> <a href="meishixinxi_updt.php?id=<?php echo mysql_result($query,$i,"id");?>">修改</a><?php } ?>
	 <a href="meishixinxidetail.php?id=<?php echo mysql_result($query,$i,"id");?>" target="_blank">详细</a></td>
  </tr>
  	<?php
	}
}
...
<p align="center"><a href="meishixinxi_list2.php?pagecurrent=1">首页</a>, <a href="meishixinxi_list2.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="meishixinxi_list2.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="meishixinxi_list2.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>
</body>
</html>
