...
<FRAME name=FrameTop src="<%=basePath %><%=dir %>/iframe/head.jsp" frameBorder=no noResize scrolling=no>
<FRAMESET border=0 name=FrameMain frameSpacing=0 frameBorder=0 cols=5,*>
