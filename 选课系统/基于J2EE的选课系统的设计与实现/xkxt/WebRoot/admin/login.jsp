...
%>
<body bgcolor=#FFFFDF text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  ...
  <tr>
    <td   valign="middle" align="center"> 
      ...
      <table width="280" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td height="30"><strong>毕业设计选题系统登录</strong></td>
        </tr>
        <tr>
      ...
      <table width="280" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          ...
          <td> 
            ...
            </table><form action="<%=basePath %>Admin.shtml" name=form1 method=post onSubmit="return checkform(form1)" autocomplete="off">
            <table width="260" border="0" cellspacing="0" cellpadding="0" align="center">
		      
              <tr> 
                <td colspan="3" class="news" height="5"> </td>
              </tr>
			 
              <tr> 
                <td width="5" class="nwes" height="36"></td>
                <td width="86" class="font1" height="36"><font color="black">用户名</font></td>
                <td> 
		            <input type="text" name="username"  size="15"  onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" 
                              onkeyup="value=value.replace(/[\W]/g,'')"/>
                </td>
              </tr>
              <tr> 
                <td class="nwes" height="36">&nbsp; </td>
                <td class="font1" height="36"><font color="black">口　令</font></td>
                <td> 
		            <input type="password" name="password" value="" size="15" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" 
                              onkeyup="value=value.replace(/[\W]/g,'')">
                </td>
              </tr>
              <tr> 
                <td class="nwes" height="36">&nbsp; </td>
                <td class="font1" height="36"><font color="black">登录身份</font></td>
                <td> 
		            <select name=method>
		            <option value=one>教务员</option>
		            <option value=two>教师</option>
		            </select>
                </td>
              </tr>
              <tr> 
