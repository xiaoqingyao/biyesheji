...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
    ...
    <%
			List pagelist3=cb.getCom("select * from cj order by id desc",6);	
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <a href="<%=basePath %><%=dir %>/s/lr.jsp?method=upCj&id=<%=pagelist2.get(0).toString()%>" target="MainFrame">修改<a></td>
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath %>ComServlet?method=delCj&id=<%=pagelist2.get(0).toString()%>">删除</a></td>
    </tr>
