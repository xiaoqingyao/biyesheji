...
<% }}%>  
    ...
    <td ><input name="xq" type="text" size="20" maxlength="100" value="<%=xq %>" onkeyup="if(!(/^[\d]+\.?\d*$/.test(this.value))){alert('您的输入有误');this.value='';this.focus();}"></td>
  </tr>
  <tr bgcolor='#FFFFFF'> 
    <td width='45%'><div align="right">课程成绩：</div></td>
    <td ><input name="cj" type="text" size="20" maxlength="100" value="<%=cj %>" onkeyup="if(!(/^[\d]+\.?\d*$/.test(this.value))){alert('您的输入有误');this.value='';this.focus();}"></td>
  </tr>
