  ...
  <TR>
	...
	<form action="<%=basePath %>/Admin.shtml?method=manager" method="post" name="form1" onSubmit="return checkUser()">
       <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		...
		<%}}else{%>	
		  <TR align="center" bgColor=#ffffff>
			<TD colspan=8 align=center id=map>当前还没有添加教务员</TD>
		  </TR>
		<%} %>  
		  </TBODY>
	   </TABLE><br>
	   ...
	   <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		  <TBODY>
		  <TR align="center" class=head>
			<TD height=23 colspan="2">增加/修改教务员</TD>
		  </TR>
		  <TR  align="center" bgColor=#ffffff>
			<TD width="40%" align="right" id=map>教务员名：</TD><input type=hidden name=ra value="">
	   ...
	   <TABLE align="center" width="80%" border="0">
		...
		<TD align="left"><div align="left">注意：1、如增加教务员，请直接输入教务员名和登录密码，并选择教务级别和使用状态，选中“增加”按钮，确定即可。<br>
		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、如修改教务员信息，请用鼠标点击教务员名，页面中部文本框会自动显示该教务员信息，修改后注意保持“修改”按钮为选中状态，确定即可。<br>
		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3、如不修改登录密码，请保持密码框为空。<br>	
		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4、如想删除某教务员，直接用鼠标点击表格后的“删除”文字即可。	<br>
		  </div></TD>
       </TR>
	   </TABLE>
	  </form>
