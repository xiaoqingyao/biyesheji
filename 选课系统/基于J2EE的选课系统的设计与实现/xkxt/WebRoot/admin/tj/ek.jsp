...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
    ...
    <% 
			List pagelist3=cb.getCom("select * from cj where cj<60 and rk='是' order by id desc",5);	
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath %>ComServlet?method=qX&id=<%=pagelist2.get(0).toString()%>">操作</a></td> 
    </tr>
