...
<%
	...
	if(username==null){
		...
		String sql="";
			...
			xq=Common.toChineseAndTrim(xq);
			String kc=request.getParameter("kc");
			kc=Common.toChineseAndTrim(kc);
			sql="select * from cj where xq='"+xq+"' and cid='"+kc+"' order by cj desc";
			float ff=0;
...
%>  
	 ...
	 <tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      <td colspan=6 align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;">总分数：<%=ff %> 分</td>
    </tr>
	 </TABLE></form>
	</td>
	</tr>
