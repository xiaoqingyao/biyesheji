...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
    ...
    <%
			List pagelist3=cb.getCom("select * from bj order by id desc",2);	
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath %>ComServlet?method=delBj&id=<%=pagelist2.get(0).toString()%>">删除</a></td>
    </tr>
...
<form name="form1" action="<%=basePath %>ComServlet?method=addBj" method="post"  >
<p align=center>班级名称：<input name="bj" type="text" size="30" maxlength="100" > 
