...
<TBODY>
  <TR>
    <TD>
      <DIV class=logo>
	 <img src=<%=basePath %>images/ad2.jpg width=950 height=100>
	  </DIV>
	</TD>
  </TR>
 </TBODY>
...
<TBODY>
  <TR>
    <TD align=middle>
	<%String username=(String)session.getAttribute("id");if(username==null){ %> 
      <%}else{ %>
      欢迎您：<%=cb.getString("select xm from stu where id='"+username+"'") %>| 
      <A href="stu.jsp" target="">修改个人信息</A> |
      
      <A href="xxk.jsp" target="">选择毕业课题</A> |
      <A href="xxy.jsp" target="">已选课题</A> |
      <A href="aff.jsp" target="">公告信息</A> |
      <A href="<%=path%>/ComServlet?method=stuExit" target="">退出登录</A> 
      <%} %> 
	</TD>
  </TR>
</TBODY>
