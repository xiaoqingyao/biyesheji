    ...
    for(HashMap map:new CommDAO().select("select * from xinwentongzhi where leibie='辅助资料' order by id desc ",1,7)){
     ...
     %>
                          <tr height="25">
                            ...
                            <td width="73" class="newslist"><%=map.get("addtime").toString().substring(0,10) %></td>
                          </tr>
                          <%
							}
							%>
              ...
              <tr>
                <td><table id="__01" width="770" height="223" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="770" height="36" background="qtimages/1_02_02_02_01.gif"><table width="98%" height="22" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="17%" align="center" valign="bottom"><strong class="STYLE1">教师风采</strong></td>
                        <td width="83%">&nbsp;</td>
                      </tr>
                    </table></td>
                  </tr>
				...
				<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                      <%
        for(HashMap m:new CommDAO().select("select * from jiaoshizhuce order by id desc",1,6)){
         %>
	    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" id="product">
	        <tr align="center">
              ...
              <a href="jiaoshizhucedetail.jsp?id=<%=m.get("id") %>" target=""><img src="<%=m.get("touxiang") %>" border="0" title="<%=m.get("xingming") %>"  height="120" width="150"/></a></div></td>
	        </tr>
	        <tr align="center">
	          <td ><a href="" 
	          			target="">
                  ...
                  <tr>
                    <td><table id="__01" width="384" height="305" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="384" height="35" background="qtimages/1_02_02_03_01_01.gif"><table width="98%" height="17" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="37%" height="17" align="center" valign="bottom"><strong><a href="zuoyexinxilist.jsp" ><font class="STYLE1">在线作业</font></a></strong></td>
                            <td width="63%">&nbsp;</td>
                          </tr>
                        </table></td>
                      </tr>
                        ...
                        <td><table id="__01" width="384" height="260" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td width="366" height="260" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="newsline">
                              <%
                                for(HashMap map:new CommDAO().select("select * from zuoyexinxi where issh='是' order by id desc",1,9)){
								%>
                              <tr height="25">
                                <td width="7%" align="center" class="newslist"><img src="qtimages/1.jpg" width="7" height="7"  /></td>
                                <td width="93%" class="newslist"><a href="zuoyexinxidetail.jsp?id=<%=map.get("id")%>"><%=Info.ensubStr(map.get("biaoti"),26)%></a></td>
                              </tr>
                              <%
							}
							%>
                    ...
                    <td><table id="__01" width="384" height="305" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="384" height="35" background="qtimages/1_02_02_03_01_01.gif"><table width="98%" height="17" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="37%" height="17" align="center" valign="bottom"><strong><a href="kejianxinxilist.jsp" ><font class="STYLE1">学习课件</font></a></strong></td>
                            <td width="63%">&nbsp;</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td><table id="__01" width="384" height="260" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td width="366" height="260" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="newsline">
                              <%
                                for(HashMap map:new CommDAO().select("select * from kejianxinxi where issh='是' order by id desc",1,9)){
								%>
                              <tr height="25">
                                <td width="7%" align="center" class="newslist"><img src="qtimages/1.jpg" width="7" height="7"  /></td>
                                <td width="93%" class="newslist"><a href="kejianxinxidetail.jsp?id=<%=map.get("id")%>"><%=Info.ensubStr(map.get("kejianmingcheng"),26)%></a></td>
                              </tr>
                              <%
							}
							%>
