...
//txixixngdy
    ...
    String url = "jiaoshizhuce_list2.jsp?1=1"; 
    String sql =  "select * from jiaoshizhuce where gonghao='"+request.getSession().getAttribute("username")+"' ";
...
//youzuiping2
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="jiaoshizhuce_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="jiaoshizhuce_list2.jsp?scid=<%=map.get("id") %>" onclick="return confirm('真的要删除？')">删除</a> <a href="jiaoshizhucedetail.jsp?id=<%=map.get("id")%>" target="_blank">详细</a> </td>
  </tr>
  	<%
  }
   %>
