...
<%
	...
	HashMap mqt = new CommDAO().getmap(id,"kejianxinxi");
	//ldlbfz
     %>
...
<table width="1000" height="1160" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%'>课件编号：</td><td width='39%'><%=mqt.get("kejianbianhao")%></td><td width='11%'>课件名称：</td><td width='39%'><%=mqt.get("kejianmingcheng")%></td></tr><tr><td width='11%'>类型：</td><td width='39%'><%=mqt.get("leixing")%></td><td width='11%'>内容：</td><td width='39%'><a href='<%=mqt.get("neirong")%>'>点此下载</a></td></tr><tr><td width='11%'>课件简介：</td><td width='39%'><%=mqt.get("kejianjianjie")%></td><td width='11%'>上传人：</td><td width='39%'><%=mqt.get("shangchuanren")%></td></tr><tr><td width='11%'>姓名：</td><td width='39%'><%=mqt.get("xingming")%></td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td colspan=4 align=center><input type=button name=Submit5 value=返回 onClick="javascript:history.back()" /></td></tr>
