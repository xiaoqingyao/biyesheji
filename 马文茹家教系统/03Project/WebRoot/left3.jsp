        ...
        <td><table width="188" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                  ...
                  <tr>
                    <td class="menubg1" onMouseover="this.className='menubg2'" onMouseout="this.className='menubg1'"><a href="jiaoshizhuce_updt2.jsp" target="right">个人资料管理</a> </td>
                  </tr>
         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="zuoyexinxi_add.jsp" target="right">作业信息添加</a></td>
                  </tr>
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="zuoyexinxi_list2.jsp" target="right">作业信息查询</a></td>
                  </tr>
         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="kejianxinxi_add.jsp" target="right">学习课件添加</a></td>
                  </tr>
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="kejianxinxi_list2.jsp" target="right">学习课件查询</a></td>
                  </tr>
         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="MyStudents.jsp" target="right">我的学生</a></td>
                  </tr>
         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="xueshengdati_list3.jsp" target="right">学生作业批改</a></td>
                  </tr>
<!--                    <tr> -->
<!--                      <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="xueshengdati_list1.jsp" target="right">学生作业查询</a></td> -->
<!--                   </tr> -->
         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="tiezi_list2.jsp" target="right">我的帖子查询</a></td>
                  </tr>
                  <!-- <tr>
