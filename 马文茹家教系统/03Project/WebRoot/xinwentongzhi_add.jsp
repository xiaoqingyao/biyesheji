...
function check()
{
  ...
  <body >
 <form  action="xinwentongzhi_add.jsp?f=f&lb=辅助材料"  method="post" name="f1"  onsubmit="return checkform();">
  添加辅助材料:
  <br><br>
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
	...
	<tr style="display:none"><td>点击率：</td><td><input name='dianjilv' type='text' id='dianjilv' value='1' />&nbsp;*</td></tr>
    <tr>
      <td>&nbsp;</td>
