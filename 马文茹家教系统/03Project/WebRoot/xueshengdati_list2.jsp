...
//txixixngdy
    ...
    String url = "xueshengdati_list2.jsp?1=1"; 
    String sql =  "select * from xueshengdati where xuesheng='"+request.getSession().getAttribute("username")+"' ";
...
//youzuiping2
 ...
 <td  style="display:none"width='80' align='center'><%=map.get("issh")%></td>
    ...
    <td width="60" align="center"><a href="xueshengdati_updt.jsp?id=<%=map.get("id")%>">提交</a>  <a href="xueshengdati_list2.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a>  </td>
  </tr>
  	<%
  }
   %>
