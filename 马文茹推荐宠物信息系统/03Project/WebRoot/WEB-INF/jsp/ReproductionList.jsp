...
<body>
	...
	<div class="container cart">
			<table>
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center">宠物品种</td>
								<td align="center">手机</td>
								<td align="center">宠物年龄</td>
				...
				<tr>
				<td colspan="7" sytle="height:10px;"></td>
				</tr>
				<tr>
				<td colspan="7">
					<form action="${ pageContext.request.contextPath }/saveReproduction.action" method="post">
						<table style="border-spacing: 10px;border-collapse: separate;border: 1px solid;">
						<tr>
						<td colspan=4>
							<strong>发布宠物求偶信息</strong>
						</td></tr>
						<tr><td width=80>宠物品种：</td><td align=left><input type="text" name="nickname"></input></td><td>地址：</td><td align=left><input type="text" name="address"></input></td></tr>
					 
						<tr><td>宠物年龄：</td><td align=left><input type="text" name="qq"></input></td><td>电话：</td><td align=left><input type="text" name="phone"></input></td></tr>
