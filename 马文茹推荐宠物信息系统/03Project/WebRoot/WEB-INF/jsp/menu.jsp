...
<%-- 					<a href="${pageContext.request.contextPath}/messageList.action?page=1" style="color: red;">留言板</a>| --%>
				...
				<c:otherwise>
				   ...
				   |<a href="${pageContext.request.contextPath}/lingyangqingqiu.action" style="color: red;">我的消息</a>
				   |</li>
<!-- 				   <li id="headerLogin" class="headerLogin" style="display: list-item;"> -->
<%-- 					<a href="${pageContext.request.contextPath}/messageList.action?page=1" style="color: red;">留言板</a> --%>
<!-- 				   |</li> -->
...
<div class="span24">
	<ul class="mainNav">
		...
		<li><a href="${pageContext.request.contextPath}/messageList.action?page=1">宠物领养</a> |</li>
		<li><a href="${pageContext.request.contextPath}/articleList.action?page=1">养宠乐享</a> |</li>
		<li><a href="${pageContext.request.contextPath}/articleAdd.action">文章发布</a> |</li>
			<li><a href="${pageContext.request.contextPath}/noticeshow.action?id=1">网站公告</a> |</li>
		<li><a href="${pageContext.request.contextPath}/reproductionlist.action?page=1">单身配对</a> |</li>
		<li><a href="${pageContext.request.contextPath}/regist.action">用户注册</a> |</li>
		<li><a href="${pageContext.request.contextPath}/login.action">用户登录</a> |</li>   
		<li><a href="${pageContext.request.contextPath}/admin.action?page=1">后台登录</a> |</li> 
<%-- 
		<li><a href="${pageContext.request.contextPath}/messageList.action?page=1">医院保健</a> |</li> 
