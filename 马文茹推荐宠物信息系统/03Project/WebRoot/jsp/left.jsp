...
<table width="100%" border="0" >
	  <tr>
		...
		<script type="text/javascript">
			...
			d.add('0106','01','消息发布','','','mainFrame');
			d.add('010601','0106','宠物领养信息','${pageContext.request.contextPath}/admin/adminMessage_findAllByPage.action?page=1','','mainFrame');
			d.add('010602','0106','单身配对信息','${pageContext.request.contextPath}/admin/adminMessage_findAllByPage2.action?page=1','','mainFrame');
			d.add('0108','01','系统设置');
			d.add('010801','0108','系统公告','${pageContext.request.contextPath}/admin/noticeset.action','','mainFrame');
			d.add('0107','01','注销退出');
